...
export declare type DeepPartial<T> = T extends Primitive | Function | Date ? T : T extends Map<infer K, infer V> ? DeepPartialMap<K, V> : T extends Set<infer U> ? DeepPartialSet<U> : T extends {} ? {
...
export declare type DeepNonNullable<T> = T extends Primitive | Function | Date ? NonNullable<T> : T extends Map<infer K, infer V> ? NonNullableMap<K, V> : T extends Set<infer U> ? NonNullableSet<U> : T extends {} ? {
...
export declare type DeepRequired<T> = T extends Primitive | Function | Date ? NonNullable<T> : T extends Map<infer K, infer V> ? RequiredMap<K, V> : T extends Set<infer U> ? RequiredSet<U> : T extends {} ? {
...
export declare type DeepReadonly<T> = T extends Primitive | Function | Date ? T : T extends Map<infer K, infer V> ? ReadonlyMap<K, V> : T extends Set<infer U> ? ReadonlySet<U> : T extends {} ? {
...
export declare type DeepWritable<T> = T extends Primitive | Function | Date ? T : T extends Map<infer K, infer V> ? WritableMap<K, V> : T extends Set<infer U> ? WritableSet<U> : T extends {} ? {
...
export declare type DeepOmit<T extends DeepOmitModify<Filter>, Filter> = T extends Primitive | Function | Date ? T : T extends Map<infer KeyType, infer ValueType> ? ValueType extends DeepOmitModify<Filter> ? DeepOmitMap<KeyType, ValueType, Filter> : T : T extends Set<infer ItemType> ? ItemType extends DeepOmitModify<Filter> ? DeepOmitSet<ItemType, Filter> : T : T extends Array<infer ItemType> ? ItemType extends DeepOmitModify<Filter> ? DeepOmitArray<ItemType, Filter> : T : {
...
declare type DeepOmitSuper<T> = {
    [K in keyof T]: T[K] extends never ? any : T[K] extends object ? DeepOmitModify<T[K]> : never;
};
declare type DeepOmitModify<T> = DeepOmitSuper<T> | DeepOmitModifyArray<T> | DeepOmitModifySet<T> | DeepOmitModifyMap<T>;
...
interface DeepOmitMap<KeyType, ValueType extends DeepOmitModify<Filter>, Filter> extends Map<KeyType, DeepOmit<ValueType, Filter>> {
}
