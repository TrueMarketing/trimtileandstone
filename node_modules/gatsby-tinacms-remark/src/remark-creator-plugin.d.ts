 ...
 */
export declare function createRemarkButton<FormShape = any, FrontmatterShape = any>(options: CreateRemarkButtonOptions<FormShape, FrontmatterShape>): AddContentPlugin<FormShape>;
export declare class RemarkCreatorPlugin<FormShape = any, FrontmatterShape = any> implements AddContentPlugin<FormShape> {
