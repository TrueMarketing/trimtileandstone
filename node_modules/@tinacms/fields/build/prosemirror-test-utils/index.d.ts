...
export declare class PMTestHarness {
     ...
     */
    text: (content: string, marks?: Mark<any>[]) => any;
    image: (attrs: ImageAttrs) => any;
    hr: () => any;
    heading: (level: number, ...nodes: Node<any>[]) => any;
}
export {};
