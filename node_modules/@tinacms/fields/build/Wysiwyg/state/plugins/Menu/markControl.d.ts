...
export declare function markControl({ mark, Icon, tooltip, defaultAttrs, selectionOnly, noMix, isDisabled, }: Options): {
    new (props: Readonly<Props>): {
        markType(markName: string): any;
        readonly active: boolean;
        markIsActive: (markName: string) => boolean;
        readonly disabled: boolean;
        readonly inCodeBlock: boolean;
        readonly incompatibleMarksAreActive: boolean;
        onClick: () => void;
